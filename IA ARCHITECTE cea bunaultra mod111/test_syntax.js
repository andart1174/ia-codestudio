...
const files = JSON.parse(decodeURIComponent(atob('JTVCJTdCJTIybmFtZSUyMiUzQSUyMnRlc3QuanMlMjIlMkMlMjJpY29uJTIyJTNBJTIyWCUyMiUyQyUyMmNvZGUlMjIlM0ElMjJjb25zb2xlLmxvZygnaGknKSUzQiUyMiU3RCU1RA==')));
let cur=0;
