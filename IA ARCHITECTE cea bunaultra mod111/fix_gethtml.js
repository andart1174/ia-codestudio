...
code = code.replace(/function getHTML\([\s\S]*?(?=function getBoilerplateCode\(\))/m, newHTML + '\n\n');
fs.writeFileSync(path, code);
console.log("getHTML fixed via Base64 mapping!");
