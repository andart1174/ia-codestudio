  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
      ...
      var catMap = {
        ...
        "🤖 AI STUDIO": ["elite", "appspro", "iaultra", "iapro", "aichat", "promo", "wizard", "onemin", "ailab", "prompt", "personaswarm", "neuro", "aipair", "aimentor", "codereview", "codepredict", "autodocs", "logicforge", "codedna", "bugfix", "codeexplain", "bizval", "genius", "vision", "voice", "nodelogic", "guide", "ai", "smartfaq", "predictor", "aichatbotrag"],
        ...
        "💫 PREMIUM STUDIOS": ["assetoptimizer", "codeprotector", "indexeddbmgr", "hardwareapi", "webrtcstreamer", "aichatbot", "svgmorphing", "meshgradient", "audiosynth", "neuralnet", "holographiccard"],
        ...
        "🚀 ADVANCED DEVELOPMENT STUDIO": ["showroom", "codesonar", "projectassembler", "dbcrudapi", "prodoptimizer", "e2etestgen", "apiclientmock", "tailwindtranspile", "a11yautofix", "npmcdnexplorer", "stateflowtracker", "webvitalsperf", "securityexploit"],
