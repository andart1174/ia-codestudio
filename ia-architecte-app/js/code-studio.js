...
function applyLang(){
  ...
  s('lbl-return-portal','returnPortal');s('lbl-editor-community','menu_community');s('lbl-subtitle','subtitle');s('lbl-tools','tools');s('lbl-preview','preview');
...
${bodyContent.trim()}
  ...
  document.getElementById('btn-publish-live').addEventListener('click',()=>{
     if (typeof window.isUserPremium === 'function' && !window.isUserPremium()) {
        if (typeof window.showPaywallModal === 'function') window.showPaywallModal();
        return;
     }
  ...
  document.getElementById('btn-netlify-pack').addEventListener('click',()=>{
     if (typeof window.isUserPremium === 'function' && !window.isUserPremium()) {
        if (typeof window.showPaywallModal === 'function') window.showPaywallModal();
        return;
     }
  ...
  document.getElementById('btn-mobile-pack').addEventListener('click',()=>{
     if (typeof window.isUserPremium === 'function' && !window.isUserPremium()) {
        if (typeof window.showPaywallModal === 'function') window.showPaywallModal();
        return;
     }
