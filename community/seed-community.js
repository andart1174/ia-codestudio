...
<html lang="en">
  ...
  <body>
    ...
    <script>
      ...
      const vs=`
    attribute vec4 p;uniform mat4 mvp;void main(){gl_Position=mvp*p;gl_PointSize=3.0;}`;
...
<html>
  <head>
    ...
    <style>
      *{margin:0;padding:0;box-sizing:border-box}body{background:#020617;overflow:hidden;font-family:monospace}
  ...
  <body>
    ...
    <script>
      ...
      function getNode(li,ni){return nodes.find(n=>
      n.li===li&&n.ni===ni);}
      let t=0;
      ...
      const g=n.glow;
      grd.addColorStop(0,`
    rgba(${100+Math.round(g*155)},${80+Math.round(g*60)},246,${0.4+g*0.6})`);
...
<html>
  ...
  <body>
    <div class="hud">
      ...
      <div class="main">
        <div class="radar-wrap">
          <canvas id="radar" width="170" height="170">
          </canvas>
          <div style="color:rgba(0,255,200,0.4);font-size:8px;letter-spacing:3px">
            RADAR SYS
          </div>
        </div>
        <div class="side">
          <div class="bar-row">
            ...
            <div class="bar-bg">
              <div class="bar-fill" id="pb" style="width:0%">
              </div>
            </div>
          </div>
          <div class="bar-row">
            ...
            <div class="bar-bg">
              <div class="bar-fill" id="sb" style="width:0%">
              </div>
            </div>
          </div>
          <div class="bar-row">
            ...
            <div class="bar-bg">
              <div class="bar-fill" id="sgb" style="width:0%">
              </div>
            </div>
          </div>
          <div class="stats-grid">
            <div class="stat-box">
              <div class="stat-val" id="lat">
                0ms
              </div>
              <div class="stat-lbl">
                LATENCY
    ...
    <script>
      ...
      ctx.fillStyle=`
    rgba(0,255,180,${alpha*0.3})`;ctx.fill();}
...
<html>
  ...
  <body>
    ...
    <script>
      ...
      ctx.strokeStyle=`
    rgba(148,163,184,${alpha*0.25})`;ctx.lineWidth=1;ctx.stroke();
    // Node A
...
<html>
  ...
  <body>
    ...
    <script>
      ...
      if(Math.random()>
      0.35)windows.push({x:wx,y:wy,on:Math.random()>0.4,r:Math.random()*2000+500});}}
      ...
      ctx.fillStyle=on?`
    rgba(255,240,180,0.7)`:`rgba(20,20,40,0.4)`;
  ...
  <body>
    ...
    <script>
      ...
      <0)py[i]=H;if(py[i]>
        ...
        ctx.fillStyle=`
    hsla(${hue[i]},100%,65%,0.7)`;ctx.fill();}
  // Cursor glow
...
<html>
  ...
  <body>
    ...
    <script>
      ...
      // Stars
      stars.forEach(s=>{ctx.beginPath();ctx.arc(s.x,s.y,s.sz,0,Math.PI*2);ctx.fillStyle=`
    rgba(255,255,255,${s.alpha})`;ctx.fill();});
  // Orbits
