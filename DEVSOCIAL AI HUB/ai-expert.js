...
(function() {
  ...
  window.StudioAI = {
    generateResponse: function(userMessage, lang) {
      ...
      // Fallback
      if (lang === 'fr') {
        return "Je comprends votre question. Cependant, je suis spécifiquement entraîné pour vous guider sur **IA ARCHITECTE** et **STUDIO 3D/4D PRO**. Pourriez-vous préciser si vous souhaitez de l'aide concernant *l'avatar webcam*, *les particules de vapeur*, *le fond vert vidéo*, *le visualiseur audio*, *l'extrusion d'image* ou *les structures voxel* ?";
      } else {
        return "I understand your query. However, I am specifically trained to help you with **IA ARCHITECTE** and **STUDIO 3D/4D PRO**. Could you specify if you need assistance with *webcam avatar setup*, *steampunk steam particles*, *chroma key video*, *audio visualizer*, *image extrusion*, or *voxel structures*?";
      }
    },
